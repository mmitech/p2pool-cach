...
#            subsidy = self.node.net.PARENT.SUBSIDY_FUNC(self.node.pow_bits.target)
    ...
    def get_work(self, _script, desired_share_target, desired_pseudoshare_target):
        ...
        if p2pool.DEBUG:
            print
            print "GenTX Timestamp (HEADER)"
            print gentx['timestamp']
            print time.time()
            print
            ...
            try:
                ...
                if pow_hash <= header['bits'].target or p2pool.DEBUG:
                    ...
                    if pow_hash <= header['bits'].target:
                        ...
                        if p2pool.DEBUG:
                            print
                            print "New GenTX Timestamp (HEADER)"
                            print new_gentx['timestamp']
                            print time.time()
                            print
                            print "Header Timestamp (HEADER)"
